...
const Footer = () => {
  ...
  return (
    <div className='row footer-container mx-0'>
      <div className={` col-lg-4 col-md-6 col-sm-12  d-flex ${!(width<600) ? "flex-column justify-content-center":" justify-content-around my-4"}`}>
        <img className='logo pb-2' src={logo} alt='logo-img'/>
        <h5 className={`${(width<600) && "align-self-center fs-1"}`} style={{color:"#F5DD61"}}>Goal E Services</h5>
      </div>
